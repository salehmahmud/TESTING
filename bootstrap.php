...
// app settings
$config = array();
$config["dropbox"]["app_key"] = "j0yhf60cxvzomhw";
$config["dropbox"]["app_secret"] = "2cg4nk60px34efe";
// ACCESS_TYPE should be "dropbox" or "app_folder"
$config["dropbox"]["access_type"] = "app_folder";

$config["app"]["root"] = ((!empty($_SERVER["HTTPS"])) ? "https" : "http") . "://" . $_SERVER["HTTP_HOST"] . "/TestDropboxPHP/";
